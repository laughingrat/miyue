    ...
    <div class="content">
      <div class="container">
        <div class="main-content">
          ...
          <p align="right"> 谢谢你，谢谢你爱我----谧月产后母婴管理中心。</p>
          ...
          %>
            <div class="col-xs-6 col-md-3">
              <a href="images/Mom/0<%= i%>.jpg" data-fancybox="group" class="thumbnail">
                <img src="images/Mom/0<%= i%>.jpg" alt="月子餐" style="height: 248px; overflow: hidden">
              </a>
            </div>
          <%
            next
